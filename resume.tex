...
\begin{CJK}{GBK}{kai}
\begin{center}
  {\textbf{\huge Honghui (Ryan) Zhang}}\\\bigskip
  210 N Charter St Apt 303, Madison, WI 53715, USA\\
...
\begin{itemize}
    \item \textbf{Programming}: C/C++, Python, JAVA, Hive, {\LaTeX},  Matlab, C\#, etc.%\\\smallskip
